...
public class RegistrationsController {
    ...
    // REMOVED @PreAuthorize to keep it simple as requested
	public ResponseEntity<String> createRegistration(@RequestBody  Registrations registration) {
		try {
            // Validate student exists and is a STUDENT (This is now the main authorization check)
            ...
            if (studentOpt.isEmpty() || studentOpt.get().getRole() != Role.STUDENT) {
                // Return FORBIDDEN if the user is not a student
